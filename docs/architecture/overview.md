...
6. After consent, the widget reports sanitized page state, an initial DOM snapshot, and bounded mutation batches so the agent viewer can render an inert replay preview.
